...
HD_PWD='C:/Users/Gina/OneDrive/Desktop/DVLSI/Lab 3/synchronous_FA_MUL/adders_mulyipliers/adders_mulyipliers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_4bit_pipeline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_4bit_pipeline.tcl
