...
HD_PWD='C:/Users/Gina/OneDrive/Desktop/DVLSI/Lab 1/shift_sreg/shift_sreg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_reg3.tcl -notrace
