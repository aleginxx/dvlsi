...
HD_PWD='C:/Users/Gina/OneDrive/Desktop/DVLSI/Lab 1/lshift_sreg/lshift_sreg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lshift_reg3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lshift_reg3.tcl -notrace
