...
HD_PWD='c:/users/gina/onedrive/desktop/dvlsi/lab/zybo_fir/tmp_edit_project.runs/FIR_design_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_design_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_design_rst_ps7_0_100M_0.tcl
