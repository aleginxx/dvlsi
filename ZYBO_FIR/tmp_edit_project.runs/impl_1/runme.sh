...
HD_PWD='c:/users/gina/onedrive/desktop/dvlsi/lab/zybo_fir/tmp_edit_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_design_wrapper.tcl -notrace
