...
HD_PWD='C:/Users/Gina/OneDrive/Desktop/DVLSI/Lab/ZYBO_FIR/ZYBO_FIR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_IP_v1_0_S00_AXI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_IP_v1_0_S00_AXI.tcl
