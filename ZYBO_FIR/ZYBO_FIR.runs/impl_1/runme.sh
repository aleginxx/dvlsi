...
HD_PWD='C:/Users/Gina/OneDrive/Desktop/DVLSI/Lab/ZYBO_FIR/ZYBO_FIR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_IP_v1_0_S00_AXI.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_IP_v1_0_S00_AXI.tcl -notrace
