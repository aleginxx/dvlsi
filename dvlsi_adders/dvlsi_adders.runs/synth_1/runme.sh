...
HD_PWD='C:/Users/zoege/OneDrive/Documents/ece/8th semester/dvlsi/Lab2/Ex2/dvlsi_adders/dvlsi_adders.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_full_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_full_adder.tcl
