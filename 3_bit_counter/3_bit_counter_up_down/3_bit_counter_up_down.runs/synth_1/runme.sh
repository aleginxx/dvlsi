...
HD_PWD='C:/Users/zoege/OneDrive/Documents/ece/8th semester/dvlsi/Lab1/ExB3/3_bit_counter_up_down/3_bit_counter_up_down.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count3_updown.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count3_updown.tcl
