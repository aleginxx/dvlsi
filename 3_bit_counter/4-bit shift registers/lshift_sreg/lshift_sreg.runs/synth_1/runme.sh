...
HD_PWD='C:/Users/Gina/OneDrive/Desktop/DVLSI/Lab 1/lshift_sreg/lshift_sreg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lshift_reg3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lshift_reg3.tcl
