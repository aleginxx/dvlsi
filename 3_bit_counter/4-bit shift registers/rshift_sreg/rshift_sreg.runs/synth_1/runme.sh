...
HD_PWD='C:/Users/Gina/OneDrive/Desktop/DVLSI/Lab 1/rshift_sreg/rshift_sreg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rshift_reg3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rshift_reg3.tcl
