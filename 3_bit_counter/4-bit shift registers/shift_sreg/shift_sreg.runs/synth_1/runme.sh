...
HD_PWD='C:/Users/Gina/OneDrive/Desktop/DVLSI/Lab 1/shift_sreg/shift_sreg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_reg3.tcl
