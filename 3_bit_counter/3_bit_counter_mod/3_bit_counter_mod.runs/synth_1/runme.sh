...
HD_PWD='C:/Users/zoege/OneDrive/Documents/ece/8th semester/dvlsi/Lab1/ExB3/3_bit_counter_mod/3_bit_counter_mod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count3_mod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count3_mod.tcl
